...
public class SuperheroController {
    ...
    public String addSuperhero(Superheros superhero,Model model, HttpServletRequest request) {
    ...
    public String performEditSuperhero(Superheros superhero, HttpServletRequest request) {
        String name = request.getParameter("name");
        String description = request.getParameter("description");
        String[] powerIds = request.getParameterValues("powerId");
        String[] organizationIds = request.getParameterValues("organizationId");
      ...
      //  return  "redirect:/detailSuperhero(id=${superhero.id})";
    }
